...
void DIO_voidSetPinDirection (u8 Copy_u8Port, u8 Copy_u8Pin, u8 Copy_u8Direction){
	if(Copy_u8Pin < 8){
		if (Copy_u8Direction == DIO_PIN_OUTPUT){
			...
			switch(Copy_u8Port){
				case DIO_PORTA: DDRA = CLR_BIT(DDRA,Copy_u8Pin); SET_BIT(PORTA,Copy_u8Pin);break;
				case DIO_PORTB: DDRB = CLR_BIT(DDRB,Copy_u8Pin); SET_BIT(PORTA,Copy_u8Pin);break;
				case DIO_PORTC: DDRC = CLR_BIT(DDRC,Copy_u8Pin); SET_BIT(PORTA,Copy_u8Pin);break;
				case DIO_PORTD: DDRD = CLR_BIT(DDRD,Copy_u8Pin); SET_BIT(PORTA,Copy_u8Pin);break;
				default:	return;	/*do nothing*/
			}
		}
